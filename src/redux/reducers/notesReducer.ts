...
import { ChangeActiveNoteAction, AddNewNoteAction, DeleteNoteAction, SaveNoteContentAction } from '../actions/notes';
...
export const notesReducer = (state: NotesState = initialState, action: Action): NotesState => {
    switch (action.type) {
